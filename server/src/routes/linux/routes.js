...
const { linuxConection } = require("../../database");
...
router.get("/emp", [], (req, res) => {
  emp.getAll(linuxConection, (data) => {
    res.json(data);
  });
});
router.get("/emp1", [], (req, res) => {
  emp.viewEmp1(linuxConection, (data) => {
    res.json(data);
  });
});
router.get("/emp2", [], (req, res) => {
  emp.viewEmp2(linuxConection, (data) => {
    res.json(data);
  });
});
router.get("/emp3", [], (req, res) => {
  emp.viewEmp3(linuxConection, (data) => {
    res.json(data);
  });
});
...
router.post(
  ...
  (req, res) => {
    ...
    emp.getId(linuxConection, ename, (data) => {
      res.json(data.id);
    });
  }
);
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    emp.create(linuxConection, body, (data) => {
      console.log(data);
      res.json(data);
    });
  }
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    emp.delete(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    emp.update(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.get("/pay", [], (req, res) => {
  pay.getAll(linuxConection, (data) => {
    res.json(data);
  });
});
/* VIiews, fragmentacion horz */
router.get("/pay1", [], (req, res) => {
  pay.viewPay1(linuxConection, (data) => {
    res.json(data);
  });
});
router.get("/pay2", [], (req, res) => {
  pay.viewPay2(linuxConection, (data) => {
    res.json(data);
  });
});
router.get("/pay3", [], (req, res) => {
  pay.viewPay3(linuxConection, (data) => {
    res.json(data);
  });
});
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    pay.create(linuxConection, body, (data) => {
      console.log(data);
      res.json(data);
    });
  }
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    pay.delete(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    pay.update(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.get("/proj", [], (req, res) => {
  proj.getAll(linuxConection, (data) => {
    res.json(data);
  });
});
router.post(
  ...
  (req, res) => {
    ...
    proj.getId(linuxConection, pname, (data) => {
      res.json(data.id);
    });
  }
);
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    proj.create(linuxConection, body, (data) => {
      console.log(data);
      res.json(data);
    });
  }
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    proj.delete(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    let body = req.body;
    proj.update(linuxConection, body, (data) => {
      res.json(data);
    });
  }
);
...
router.get("/asg", [], (req, res) => {
  asg.getAll(linuxConection, (data) => {
    res.json(data);
  });
});
...
router.post(
  ...
  async (req, res) => {
    ...
    if (res_emp && res_proj) {
      ...
      asg.create(linuxConection, body, (data) => {
        console.log(data);
        res.json(data);
      });
    } else {
...
router.post(
  ...
  async (req, res) => {
    ...
    if (res_emp && res_proj) {
      body.ename = res_emp.eno;
      body.pname = res_proj.pno;
      asg.update(linuxConection, body, (data) => {
        res.json(data);
      });
    } else {
      res.status(400).send("No se encontro un empleado o proyecto");
